...
import { getBudgetState, checkBudget } from '../services/budget-store.js';
import type { Env, UserRecord } from '../types/index.js';

type HonoEnv = { Bindings: Env; Variables: { user: UserRecord } };

export const budgetGuardMiddleware = createMiddleware<HonoEnv>(
  async (c, next) => {
